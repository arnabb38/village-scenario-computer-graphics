...
void cloud1()
{
	...
	glBegin(GL_TRIANGLE_FAN);
	    glColor3ub(20, 20, 20);   //ccccccccccccccccccccccccccccccccccc
...
void bird()
{
	...
	glBegin(GL_TRIANGLE_FAN);
	    glColor3ub(225, 100, 100);  //225, 225, 208
...
//eeeeeeeeeeeeeeeeeeexxxxxxxxxxxxxxxxxxxxxppppppppppppppppppeeeeeeeeeeeerrrrrrrrrrrient
void hut2()
{
    glBegin(GL_POLYGON);
    glColor3ub(204, 153, 0);
...
//experiment sessssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss
...
void boat()
{
	...
	glBegin(GL_POLYGON);
	glColor3ub(255, 153, 0);     //255, 153, 0
...
void DrawSphere()
{
    ...
    boat3();
    hut1();
    hut2 (); //eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    tree();
    backgroundtree();
    fence();
    grass4();
...
void handleKeypress(unsigned char key, int x, int y) {
	switch (key) {
	    case  'd':
            ...
            PlaySound(TEXT("100473__iluppai__village-at-morning.wav"), NULL, SND_ASYNC); // bird-2
            break;
        case 'r':
            glutDestroyWindow(1);
	        glutInitWindowSize(1240, 750);
            ...
            PlaySound(TEXT("432216__neilraouf__heavy-rain-and-thunder-grwol-48-khz-24bit.wav"), NULL, SND_ASYNC);
            break;
         case 'n':
            glutDestroyWindow(1);
	        glutInitWindowSize(1240, 750);
            ...
            PlaySound(TEXT("352514__inspectorj__ambience-night-wildlife-a.wav"), NULL, SND_ASYNC);
            glutPostRedisplay();
            break;
        case  'D':
	        glutDestroyWindow(1);
            ...
            glutKeyboardFunc(handleKeypress);
            glutDisplayFunc(display);
            PlaySound(TEXT("100473__iluppai__village-at-morning.wav"), NULL, SND_ASYNC);
            break;
            break;
        case 'R':
            glutDestroyWindow(1);
...
{
    glutInit(&argc, argv);
    glutInitWindowSize(1240, 750); //1240, 750
    glutInitWindowPosition((glutGet(GLUT_SCREEN_WIDTH)-1240)/2,(glutGet(GLUT_SCREEN_HEIGHT)-750)/2);
    glutCreateWindow("village scenario");
    init();
